...
var DomainHtml, couponsCode, couponsTitle, couponsDiscript, cashbackTitle, codeCount, myObj, popupHeight, popupWidth, codeObj, finalCode, finalAmount, couponCode, backgroungClr, InstallObj, parameters, cashback_affiliate, cashbackValue, iframe, cartpageUrl, kohlsWalletApi, coupon_affiliate, domainPageUrl, couponcookie, cashbackcookievar, strCookies, cashbackEndDate, elemMouseEvent, payless, bathandbodyCouponApi, macysCouponApi, macysCoupRemoveApi, forever21CouponApi, forever21CoupRemoveApi, bathandbodyWalletApi, bathandbodyRemoveApi, footlockerCouponApi, footlockerCsrfToken, famousfootwearCouponApi, shoecarCouponApi, shoecarWalletApi, steinmartCouponApi, steinmartWalletApi, carterWalletApi, officeCouponApi, officeCoupRemoveApi, walgreenCartIdApi, advanceautoWalletApi, searsCouponApi, searsWalletApi, wallCartId, wallObj, cabelasWalletApi, cabelasCouponApi, cabelasRemCouponApi, lordWalletApi, partyCouponApi, partyWalletApi, aeroCouponApi, aeroWalletApi, shuttCouponApi, dressCouponApi, vitaCouponApi, vitaparams, brookCouponApi, dollarCouponApi, dollarWalletApi, puritanCouponApi, fromyouCouponApi, eddieCouponApi, eddieWalletApi, tomsCouponApi, tomsRemCouponApi, mathRand, straightCouponApi, shoeCouponApi, shopbopCouponApi, harryCouponApi,harryInfoApi, harryOrderId, michaelsCouponApi,columbiaCouponApi, columbiaRemCouponApi, michaelsWalletApi, avenueCouponApi, lenovoCouponApi, totalHPpriceNumber, dellCouponApi, reebokCouponApi, reebokRemoveApi, reebokBasketId, reebokWalletApi, dermCouponApi, cheapArrayIndex, cheapoairTempCoupon, jcrewCouponApi, appVersion, bodybuildingCouponApi, bodybuildingParms, sierraCouponApi, sierraCouponApi, sierroriginalShipping, victoCouponApi, restCouponApi, pepboysCouponApi, ebagsCouponApi, snapfishCouponApi, michaelsCouponRemApi, yankeeCouponApi, yankeeCouponRemApi, guitarCouponApi, juicyCouponApi, nyandcompanyCouponApi, nyandcompanyWalletApi, nyandcompanyCouponRemApi, dunkinCouponApi, tireCouponApi, cottononCouponApi, blairCouponApi, speckCouponApi, specksavings, eyebuyCouponApi, ashfordCouponApi, ashfordCouponRemApi, rockbottomgolfCouponApi, shopkoCouponApi, shoescrewsCouponApi, bhcosmeticsCouponApi, destinCouponApi, destinRemCouponApi, christoCouponApi, christoRemCouponApi, clarisonicCouponApi, clarisonicRCouponApi, cafepressCouponApi, catherinesCouponApi, contacts1800CouponApi, pillowCouponApi, barenCouponApi, naturalCouponApi, musicianCouponApi, musicianRemCouponApi, scrubCouponApi, scrubNetAmmount, avedaCouponApi, backCouponApi, zaggCouponApi, kedsCouponApi, renttheCouponApi, somaCouponApi, spiritCouponApi, spiritWalletApi, clairesCouponApi, clairesRemCouponApi, ashleyCouponApi, buildCouponApi, mixbookCouponApi, belkCouponApi, fragCouponApi, landCouponApi, fetchPinN, fredCouponApi, fredWalletApi, perfuCouponApi, travelCouponApi, travelrmvCouponApi, revolveCouponApi, appVersionObj, keurigCouponApi, keurigCouponRemApi, newbalanceCouponApi, orvisCouponApi,orvisCoupRemoveApi, newbalanceRemApi, bloomingCouponApi, nastygalCouponApi, hanesCouponApi, paylessCouponApi, quillCouponApi;

var pTime = 1500;
var indexSupportedSite = 0;
var indexSupportedCart = 0;
...
var partners = {
	SupportedSites: [{
			...
			couponcookies: "kohlscoupon",
			cashbackcookies: "kohlscashback"
		}, {
			domain: "macys.com",
			cart: ["www.macys.com/my-bag"],
			couponcookies: "macyscoupon",
			cashbackcookies: "macyscashback"
		}, {
			...
			couponcookies: "fore21coupon",
			cashbackcookies: "fore21cashback"
		}, {
			...
			couponcookies: "walgreenscoupon",
			cashbackcookies: "walgreenscashback"
		}, {
			...
			couponcookies: "officedepotcoupon",
			cashbackcookies: "officedepotcashback"
		}, {
			...
			couponcookies: "famousfootcoupon",
			cashbackcookies: "famousfootcashback"
		}, {
			domain: "sears.com",
			...
			couponcookies: "searscoupon",
			cashbackcookies: "searscashback"
		}, {
			domain: "payless.com",
			cart: ["payless.com/checkout"],
			paylessCouponUrl: "https://www.payless.com/api/checkout/pub/orderForm/",
			couponcookies: "paylesscoupon",
			cashbackcookies: "paylesscashback"
		}, {
			domain: "finishline.com",
			cart: ["www.finishline.com/store/cart/cart.jsp"],
			couponcookies: "finishlinecoupon",
			cashbackcookies: "finishlinecashback"
		}, {
			...
			couponcookies: "footlockercoupon",
			cashbackcookies: "footlockercashback"
		}, {
			...
			couponcookies: "autopartcoupon",
			cashbackcookies: "autopartcashback"
		}, {
			...
			couponcookies: "bathandbodycoupon",
			cashbackcookies: "bathandbodycashback"
		}, {
			domain: "ae.com",
			cart: ["ae.com/us/en/cart", "ae.com/us/en/checkout", "ae.com/aerie/cart"],
			aeCouponUrl: "https://www.ae.com/ugp-api/cart/v1/claimCoupon",
			aeWalletUrl: "ae.com/cart",
			couponcookies: "aecoupon",
			cashbackcookies: "aecashback"
		}, {
			...
			couponcookies: "barnescoupon",
			cashbackcookies: "barnescashback"
		}, {
			...
			couponcookies: "steincoupon",
			cashbackcookies: "steincashback"
		}, {
			domain: "lanebryant.com",
			cart: ["www.lanebryant.com/cart/cart.jsp"],
			couponcookies: "lanebrycoupon",
			cashbackcookies: "lanebrycashback"
		}, {
			domain: "keurig.com",
			...
			couponcookies: "keurigcoupon",
			cashbackcookies: "keurigcashback"
		}, {
			domain: "carters.com",
			cart: ["carters.com/cart"],
			carterWalletUrl: "https://www.carters.com/cart?dwcont=C157772355",
			couponcookies: "carterscoupon",
			cashbackcookies: "carterscashback"
		}, {
			domain: "cabelas.com",
			...
			couponcookies: "cabelascoupon",
			cashbackcookies: "cabelascashback"
		}, {
			domain: "lordandtaylor.com",
			cart: ["lordandtaylor.com"],
			lordWalletUrl: "https://www.lordandtaylor.com/checkout/checkout.jsp",
			couponcookies: "lordandtaycoupon",
			cashbackcookies: "lordandtaycashback"
		}, {
			domain: "partycity.com",
			cart: ["www.partycity.com/cart"],
			partyCouponUrl: "https://www.partycity.com/on/demandware.store/Sites-partycity_us-Site/en_US/Cart-SubmitForm",
			...
			couponcookies: "partycitycoupon",
			cashbackcookies: "partycitycashback"
		}, {
			domain: "aeropostale.com",
			cart: ["www.aeropostale.com/cart"],
			...
			couponcookies: "nastycoupon",
			cashbackcookies: "nastycashback"
		}, {
			domain: "hanes.com",
			cart: ["hanes.com/checkout/cart"],
			hanesCouponUrl: "https://www.hanes.com/checkout/cart/couponPost/",
			couponcookies: "hanescoupon",
			cashbackcookies: "hanescashback"
		}, {
			domain: "vitacost.com",
			cart: ["www.vitacost.com/Checkout"],
			vitaCouponUrl: "https://www.vitacost.com/Checkout.aspx",
			couponcookies: "vitacoupon",
			cashbackcookies: "vitacashback"
		}, {
			domain: "bebe.com",
			cart: ["bebe.com"],
			...
			couponcookies: "bebecoupon",
			cashbackcookies: "bebecashback"
		}, {
			domain: "brookstone.com",
			cart: ["brookstone.com"],
			brookCouponUrl: "https://www.brookstone.com/cart?dwcont=C412886697",
			couponcookies: "brookcoupon",
			cashbackcookies: "brookcashback"
		}, {
			...
			couponcookies: "newbalaecoupon",
			cashbackcookies: "newbalacashback"
		}, {
			...
			couponcookies: "dollarcoupon",
			cashbackcookies: "dollarcashback"
		}, {
			domain: "bluenile.com",
			cart: ["secure.bluenile.com/basket.html"],
			couponcookies: "bluenilecoupon",
			cashbackcookies: "bluenilecashback"
		}, {
			domain: "puritan.com",
			cart: ["www.puritan.com/shoppingcart"],
			puritanCouponUrl: "https://www.puritan.com/shoppingcart/applyCoupon",
			couponcookies: "puritancoupon",
			cashbackcookies: "puritancashback"
		}, {
			domain: "fromyouflowers.com",
			cart: ["www.fromyouflowers.com/cart.htm"],
			fromyouCouponUrl: "https://www.fromyouflowers.com/cart.htm",
			couponcookies: "fromyoucoupon",
			cashbackcookies: "fromyoucashback"
		}, {
			...
			couponcookies: "davidscoupon",
			cashbackcookies: "davidscashback"
		}, {
			domain: "herbergers.com",
			cart: ["www.herbergers.com/checkout"],
			couponcookies: "herbercoupon",
			cashbackcookies: "herbercashback"
		}, {
			...
			couponcookies: "eddiecoupon",
			cashbackcookies: "eddiecashback"
		}, {
			domain: "toms.com",
			cart: ["toms.com"],
			...
			couponcookies: "tomscoupon",
			cashbackcookies: "tomscashback"
		}, {
			domain: "younkers.com",
			cart: ["www.younkers.com/checkout"],
			couponcookies: "younkerscoupon",
			cashbackcookies: "younkerscashback"
		}, {
			domain: "shop.straighttalk.com",
			...
			couponcookies: "straighcoupon",
			cashbackcookies: "straighcashback"
		}, {
			domain: "fossil.com",
			cart: ["fossil.com/en-us/cart", "fossil.com/on/demandware.store/Sites-fossil-na-Site/en_US/Checkout-Begin"],
			couponcookies: "fossilcoupon",
			cashbackcookies: "fossilcashback"
		}, {
			...
			couponcookies: "shoecarnivalcoupon",
			cashbackcookies: "shoecarnivalcashback"
		}, {
			domain: "shopbop.com",
			cart: ["www.shopbop.com/s/cart"],
			shopbopCouponUrl: "https://www.shopbop.com/s/cart/promotioncode",
			couponcookies: "shopbopcoupon",
			cashbackcookies: "shopbopcashback"
		}, {
			...
			couponcookies: "harrycoupon",
			cashbackcookies: "harrycashback"
		}, {
			domain: "columbia.com",
			...
			couponcookies: "bloomingdalescoupon",
			cashbackcookies: "bloomingdalescashback"
		}, {
			domain: "hp.com",
			cart: ["store.hp.com/webapp/wcs/stores/servlet/AjaxOrderItemDisplayView"],
			couponcookies: "hpcoupon",
			cashbackcookies: "hpcashback"
		}, {
			domain: "dell.com",
			cart: ["www.dell.com/en-us/cart"],
			dellCouponUrl: "https://www.dell.com/csbapi/en-us/cart/coupon",
			couponcookies: "dellcoupon",
			cashbackcookies: "dellcashback"
		}, {
			domain: "kmart.com",
			cart: ["www.kmart.com/crsp/mx/cart"],
			kmartCouponUrl: "https://www.kmart.com/crsp/api/cart/v1/coupon/add",
			couponcookies: "kmartcoupon",
			cashbackcookies: "kmartcashback"
		}, {
			domain: "ediblearrangements.com",
			cart: ["ediblearrangements.com/fruit-cart"],
			couponcookies: "ediblecoupon",
			cashbackcookies: "ediblecashback"
		}, {
			domain: "reebok.com",
			...
			couponcookies: "reebokcoupon",
			cashbackcookies: "reebokcashback"
		}, {
			domain: "ralphlauren.com",
			cart: ["www.ralphlauren.com/cart"],
			couponcookies: "ralphlaurencoupon",
			cashbackcookies: "ralphlaurencashback"
		}, {
			domain: "dermstore.com",
			cart: ["dermstore.com/cart"],
			dermCouponUrl: "https://www.dermstore.com/cart/ajax/cart.php",
			couponcookies: "dermstorecoupon",
			cashbackcookies: "dermstorecashback"
		}, {
			domain: "cheapoair.com",
			cart: ["www.cheapoair.com/fpnext/Payment/Air"],
			couponcookies: "cheapoaircoupon",
			cashbackcookies: "cheapoaircashback"
		}, {
			domain: "jcrew.com",
			cart: ["jcrew.com/checkout"],
			jcrewCouponUrl: "https://www.jcrew.com/checkout-api/graphql",
			couponcookies: "jcrewcoupon",
			cashbackcookies: "jcrewcashback"
		}, {
			...
			couponcookies: "bodybuildingcoupon",
			cashbackcookies: "bodybuildingcashback"
		}, {
			...
			couponcookies: "sierratradcoupon",
			cashbackcookies: "sierratradcashback"
		}, {
			...
			couponcookies: "victoriacoupon",
			cashbackcookies: "victoriacashback"
		}, {
			domain: "restaurant.com",
			cart: ["www.restaurant.com/cart"],
			restCouponUrl: "https://www.restaurant.com/Shared/Shared/ApplyPromoCode",
			couponcookies: "restaurantcoupon",
			cashbackcookies: "restaurantcashback"
		}, {
			domain: "bookit.com",
			cart: ["from.bookit.com/review.php"],
			couponcookies: "bookitcoupon",
			cashbackcookies: "bookitcashback"
		}, {
			domain: "pepboys.com",
			cart: ["www.pepboys.com/cart"],
			pepboysCouponUrl: "https://www.pepboys.com/cart/ajax/applyPromo",
			couponcookies: "pepboyscoupon",
			cashbackcookies: "pepboyscashback"
		}, {
			domain: "ebags.com",
			cart: ["ebags.com/cart"],
			couponcookies: "ebagscoupon",
			cashbackcookies: "ebagscashback"
		}, {
			domain: "orientaltrading.com",
			cart: ["www.orientaltrading.com/web/shoppingcart"],
			couponcookies: "orientalcoupon",
			cashbackcookies: "orientalcashback"
		}, {
			domain: "orvis.com",
			cart: ["orvis.com/cart"],
			...
			couponcookies: "orviscoupon",
			cashbackcookies: "orviscashback"
		}, {
			...
			couponcookies: "yankeecoupon",
			cashbackcookies: "yankeecashback"
		}, {
			domain: "guitarcenter.com",
			cart: ["www.guitarcenter.com/cart"],
			guitarCouponUrl: "https://www.guitarcenter.com/checkout/shipping?_DARGS=/cko/shipping.jsp.couponForm",
			couponcookies: "guitarcoupon",
			cashbackcookies: "guitarcashback"
		}, {
			domain: "juicycouture.com",
			cart: ["www.juicycouture.com/Cart"],
			juicyCouponUrl: "https://www.juicycouture.com/Cart/ApplyPromoCode",
			couponcookies: "juicycoupon",
			cashbackcookies: "juicycashback"
		}, {
			domain: "nyandcompany.com",
			cart: ["www.nyandcompany.com/checkout"],
			...
			couponcookies: "nyandcoupon",
			cashbackcookies: "nyandcashback"
		}, {
			...
			couponcookies: "dunkcoupon",
			cashbackcookies: "dunkcashback"
		}, {
			...
			couponcookies: "tirebuyercoupon",
			cashbackcookies: "tirebuyercashback"
		}, {
			domain: "cottonon.com",
			cart: ["cottonon.com/US/bag"],
			...
			couponcookies: "cottononcoupon",
			cashbackcookies: "cottononcashback"
		}, {
			domain: "blair.com",
			cart: ["blair.com/checkout"],
			blairCouponUrl: "https://www.blair.com/api/user-service/user/order/brand/blair/promoCode/",
			couponcookies: "blaircoupon",
			cashbackcookies: "blaircashback"
		}, {
			...
			couponcookies: "speckcoupon",
			cashbackcookies: "speckcashback"
		}, {
			domain: "jimmyjazz.com",
			cart: ["jimmyjazz.com"],
			couponcookies: "jimmycoupon",
			cashbackcookies: "jimmycashback"
		}, {
			domain: "eyebuydirect.com",
			cart: ["www.eyebuydirect.com/cart"],
			eyebuyCouponUrl: "https://www.eyebuydirect.com/cart?action=redeem_coupon",
			couponcookies: "eyebuycoupon",
			cashbackcookies: "eyebuycashback"
		}, {
			domain: "ashford.com",
			cart: ["ashford.com/checkout"],
			ashfordCouponUrl: "https://www.ashford.com/checkout/cart/couponPost/",
			couponcookies: "ashfordcoupon",
			cashbackcookies: "ashfordcashback"
		}, {
			...
			couponcookies: "rockbottomcoupon",
			cashbackcookies: "rockbottomcashback"
		}, {
			domain: "shopko.com",
			cart: ["www.shopko.com/checkout"],
			shopkoCouponUrl: "https://www.shopko.com/checkout/update_promo_code_ajax.cmd",
			couponcookies: "shopkocoupon",
			cashbackcookies: "shopkocashback"
		}, {
			...
			couponcookies: "destincoupon",
			cashbackcookies: "destincashback"
		}, {
			...
			couponcookies: "christocoupon",
			cashbackcookies: "christocashback"
		}, {
			domain: "alibris.com",
			cart: ["www.alibris.com/cart"],
			alibrisCouponUrl: "https://www.alibris.com/cart.processCoupon",
			couponcookies: "alibriscoupon",
			cashbackcookies: "alibriscashback"
		}, {
			...
			couponcookies: "clarisoniccoupon",
			cashbackcookies: "clarisoniccashback"
		}, {
			...
			couponcookies: "cafepressccoupon",
			cashbackcookies: "cafepresscashback"
		}, {
			...
			couponcookies: "catherinescoupon",
			cashbackcookies: "catherinescashback"
		}, {
			domain: "carsons.com",
			cart: ["www.carsons.com/checkout"],
			couponcookies: "carsonscoupon",
			cashbackcookies: "carsonscashback"
		}, {
			...
			couponcookies: "contactscoupon",
			cashbackcookies: "contactscashback"
		}, {
			domain: "mypillow.com",
			cart: ["mypillow.com/checkout/cart/"],
			pillowCouponUrl: "https://www.mypillow.com/checkout/cart/couponPost/",
			couponcookies: "mypillowcoupon",
			cashbackcookies: "mypillowcashback"
		}, {
			...
			couponcookies: "barenecoupon",
			cashbackcookies: "barenecashback"
		}, {
			...
			couponcookies: "naturalizercoupon",
			cashbackcookies: "naturalizercashback"
		}, {
			domain: "bodenusa.com",
			cart: ["checkout.bodenusa.com/en-US"],
			couponcookies: "bodenusacoupon",
			cashbackcookies: "bodenusacashback"
		}, {
			...
			couponcookies: "musiciancoupon",
			cashbackcookies: "musiciancashback"
		}, {
			...
			couponcookies: "scrubsandcoupon",
			cashbackcookies: "scrubsandcashback"
		}, {
			domain: "aveda.com",
			cart: ["aveda.com/checkout/viewcart"],
			avedaCouponUrl: "https://www.aveda.com/rpc/jsonrpc.tmpl?dbgmethod=logic.checkout--viewcart",
			couponcookies: "avedacoupon",
			cashbackcookies: "avedacashback"
		}, {
			domain: "ctshirts.com",
			cart: ["ctshirts.com/us/cart"],
			couponcookies: "ctshirtscoupon",
			cashbackcookies: "ctshirtscashback"
		}, {
			...
			couponcookies: "backcountrycoupon",
			cashbackcookies: "backcountrycashback"
		}, {
			domain: "elder-beerman.com",
			cart: ["www.elder-beerman.com/checkout"],
			couponcookies: "beermancoupon",
			cashbackcookies: "beermancashback"
		}, {
			domain: "zagg.com",
			cart: ["www.zagg.com/en_us/checkout/cart/"],
			zaggCouponUrl: "https://www.zagg.com/en_us/checkout/cart/couponPost",
			couponcookies: "zaggcoupon",
			cashbackcookies: "zaggcashback"
		}, {
			domain: "keds.com",
			cart: ["www.keds.com/en/cart"],
			couponcookies: "kedscoupon",
			cashbackcookies: "kedscashback"
		}, {
			...
			couponcookies: "rentthecoupon",
			cashbackcookies: "rentthecashback"
		}, {
			domain: "bonton.com",
			cart: ["www.bonton.com/checkout"],
			couponcookies: "bontoncoupon",
			cashbackcookies: "bontoncashback"
		}, {
			domain: "kennethcole.com",
			cart: ["www.kennethcole.com/cart"],
			couponcookies: "kennethcoupon",
			cashbackcookies: "kennethcashback"
		}, {
			domain: "soma.com",
			...
			couponcookies: "somacoupon",
			cashbackcookies: "somacashback"
		}, {
			domain: "spirithalloween.com",
			cart: ["spirithalloween.com/checkout"],
			...
			couponcookies: "spiritcoupon",
			cashbackcookies: "spiritcashback"
		}, {
			domain: "claires.com",
			...
			couponcookies: "clairescoupon",
			cashbackcookies: "clairescashback"
		}, {
			...
			couponcookies: "fragrancenetcoupon",
			cashbackcookies: "fragrancenetcashback"
		}, {
			domain: "landsend.com",
			cart: ["www.landsend.com/co/checkout/shopping-bag"],
			landCouponUrl: "https://www.landsend.com/co/checkout/applyPromotion",
			couponcookies: "landsendcoupon",
			cashbackcookies: "landsendcashback"
		}, {
			...
			couponcookies: "frederickscoupon",
			cashbackcookies: "frederickscashback"
		}, {
			domain: "perfumania.com",
			cart: ["perfumania.com"],
			couponcookies: "perfumaniacoupon",
			cashbackcookies: "perfumaniacashback"
		}, {
			...
			couponcookies: "travelocoupon",
			cashbackcookies: "travelocashback"
		}, {
			domain: "revolve.com",
			cart: ["www.revolve.com/r/PaymentOptions.jsp"],
			revolveCouponUrl: "https://www.revolve.com/r/ajax/ApplyPromoCode.jsp",
			couponcookies: "revolvecoupon",
			cashbackcookies: "revolvecashback"
		}
	]
}
...
setTimeout(() => {
 ...
 //////// Code for get coupons from api at onload event of webpage //////////
 ////// Code for cashback found screen and coupons found screen ////////////////
 //////// Code for IsLogin api for check user is login or not in couponchief website for cashback ////////
function onload() {
	...
	chrome.storage.local.get(["appVersion"], function (items) {
		...
		if (appVersionObj) {
			...
			indexSupportedSite = isInSupportedSites(CurrHost);
			if (indexSupportedSite) {
				
				cartpageUrl = partners.SupportedSites[indexSupportedSite - 1].cart;
				domainPageUrl = partners.SupportedSites[indexSupportedSite - 1].domain;
				couponcookie = partners.SupportedSites[indexSupportedSite - 1].couponcookies;
				cashbackcookie = partners.SupportedSites[indexSupportedSite - 1].cashbackcookies;
				...
				if (CurrHref.indexOf("www.famousfootwear.com") > -1) {
				...
				if (CurrHref.indexOf("www.bathandbodyworks.com") > -1) {
					...
					bathandbodyRemoveApi = partners.SupportedSites[indexSupportedSite - 1].bathandbodyRemoveUrl;
				}
				...
				if (CurrHref.indexOf("vitacost.com") > -1) {
				...
				if (CurrHref.indexOf("brookstone.com") > -1) {
					brookCouponApi = partners.SupportedSites[indexSupportedSite - 1].brookCouponUrl;
				}
				...
				if (CurrHref.indexOf("shop.straighttalk.com") > -1) {
					...
					CurrHost = CurrHost.replace("shop.", "");
				}
				...
				if (CurrHref.indexOf("secure.bluenile.com") > -1) {
					CurrHost = CurrHost.replace("secure.", "");
				}
				...
				if (CurrHref.indexOf("lenovo.com") > -1) {
					...
					CurrHost = CurrHost.replace("www3.", "");
				}
				...
				if (CurrHref.indexOf("from.bookit.com") > -1) {
					CurrHost = CurrHost.replace("from.", ""); ;
				}
				...
				if (CurrHref.indexOf("www8.hp.com") > -1) {
					CurrHost = CurrHost.replace("www8.", "");
				}
				...
				if ((CurrHref.indexOf("checkout.bodenusa.com") > -1) || (CurrHref.indexOf("checkout.blair.com") > -1)) {
					CurrHost = CurrHost.replace("checkout.", "");
				}
				savingsAtOnload();
				chrome.storage.local.get(null, function (obj) {
					var lastCookiclear = JSON.stringify(obj.oneTimeCookies);
					if (lastCookiclear) {
						lastCookiclear = lastCookiclear.replace(/['"]+/g, '');
					}
					if (!lastCookiclear) {
						...
						if (isFromExtension == "true") {
						popupHeight = "273px";
						backgroungClr = "#F4F4F4";
						popupWidth = "350px";
						style = "<style>*{box-sizing:border-box}.container{font-family:Lato;text-align:center;position:relative;background:#F4F4F4;color:#505050; }.logo{float:left;width:92%}.logo img{width:180px}header{box-shadow:.7px .7px 9.5px .5px rgba(0,0,0,.1);padding:8px 8px 2px;width:100%;float:left;background:#fff;border:1px solid #f6f6f6}h3{font-weight:400;}.content {background: #fff;width: 330px;height: 158px;margin-left: 10px;padding: 4px 14px;float: left;margin-top: 8px;box-shadow: 0.7px 0.7px 9.5px 0.5px rgba(0,0,0,.1);}.mg-4{margin:10px;font-size:16px;}.close{float:right;color:#C2C2C2;font-size:24px;line-height:15px;cursor:pointer}a{text-decoration:underline;color:#27a7da;cursor:pointer;}p{font-size:13px;text-align:justify; margin:5px 0;}.footer {background: #ece9e9;padding: 0 13px;float: left;width: 332px;margin-left: 2.5%;}body {margin: 0px;}.text-center{text-align:center;}</style>";
						DomainHtml = fontApi + "<div class='container'> <header> <div class='logo'> <img src='" + imagePathLoc + "scout_logo.png'/> </div><div class='close' id='closeiframe' ><img style='width:10px;margin-top:7px; margin-right: 2px;' src='" + imagePathLoc + "cross.png' /></div></header> <div class='content'> <h3 class='mg-4'>Welcome to the easiest way to save money!</h3> <p>Scout is designed to hunt down the best deals for you. Simply add items to your cart, and let Scout do the heavy lifting. Scout will automatically find the best discounts available and will apply them automatically.</p><p class='text-center'><a  id='closeWelcome' >Got it</a></p></div><div class='footer'><p>Don’t need to save money today? You can remove Scout by right clicking on the Scout icon and select remove from your browser.</p></div></div>";
						createIframe(DomainHtml, myObj);
						chrome.storage.local.set({
							"oneTimeCookies": "true"
						}, function () {});
						}
					} else {
						indexSupportedCart = isInSupportCart(CurrHref)
							if ((CurrHref.indexOf(domainPageUrl) > -1) && (!indexSupportedCart)) {
								after24Hours(cashbackcookie);
							} else {
								for (var t = 0; t < cartpageUrl.length; t++) {
									if (CurrHref.indexOf(cartpageUrl[t]) > -1) {
										after24Hours(couponcookie);
									}
								}
							}
					}
...
function after24Hours(strCookies) {
			...
			storage.get(strCookies, function (result) {
				...
				if ((time_now - lastclear) > 1000 * 60 * 60 * 24) {
					chrome.storage.local.get(["installId"], function (items) {
						...
						parameters = "installation_id=" + InstallObj + "&url=" + CurrHost + "";
						...
						xmlhttp.onreadystatechange = function () {
							if (this.readyState == 4 && this.status == 200) {
								...
								if (myObj) {
									...
									coupon_affiliate = myObj.affiliateLink;
									storage.set({
										[CurrHost]: myObj
									});
									chrome.storage.local.set({
									...
									index = contains.call(cartpageUrl, CurrHref);
									if ((CurrHref.indexOf(domainPageUrl) > -1) && (myObj.cashback.length > 0) && (!index)) {
										cashbackTitle = myObj.cashback[0].title;
										...
										backgroungClr = "#F4F4F4";
										popupWidth = "350px";
										style = "<style>*{box-sizing:border-box}.container{margin:0 auto;text-align:center;height:190px;font-family:Lato;color:#616161}.content,header{background:#fff;box-shadow: 0.7px 0.7px 9.5px 0.5px rgba(0, 0, 0, 0.1)}.logo img{width:180px;margin-left: 15px;}.logo{width: 304px;float: left;}header{padding:8px 8px;height:40px;margin-bottom:8px}h3.mg-10{font-weight:600;font-size: 13px;word-wrap: break-word;height: 35px;overflow: hidden; margin-bottom: 5px;}.content{width:332px;height:145px;margin:0px auto;padding:10px;}.mg-10{margin:10px}.sbtbtn {width: 150px; border: 1px solid #FD601C;background: #FD601C;border-radius: 20px;padding: 8px 8px;margin-top:0px;color: #fff;font-size: 14px;font-family: Lato; font-weight:bold;}.actbtn {width: 150px; border: 1px solid #28c6c5;display: none;background-color:#28c6c5;border-radius: 20px;padding: 8px 30px;margin-top: 0px;color: #fff;font-size: 14px;font-family: Lato;}.learnMore{color:#4DA89A;margin-top:15px;display:inline-block;text-decoration:underline;text-transform:capitalize;font-size:14px}#linkMyWallet{display:none;}.close{float:right;color:#C2C2C2;cursor:pointer;position: absolute;top: 15px;right: 13px;}button{cursor:pointer}:focus{outline:none}button{cursor:pointer}button img{cursor:auto}.sbtbtn:hover{background:#f5a972;;border:1px solid #f5a972;}.actbtn:hover{background:#99dff2;;border:1px solid #99dff2;}body {margin: 0px;}</style>";
										DomainHtml = fontApi + "<div class='container'><header><div class='logo'><img src='" + imagePathLoc + "scout_logo.png' /></div><div class='close' id='closeiframe' ><img style='width: 10px;' src='" + imagePathLoc + "cross.png' /></div></header><div class='content'><h3 class='mg-10'>" + cashbackTitle + "</h3><div style='position:relative'><button class='sbtbtn' id='applycashback' >Log In & Activate</button><button class='actbtn' id='activeCashback' >Activate</button><span id='checkCashback' style='color: rgb(40, 198, 197);display: none;font-size: 20px;position:absolute;top:0px;right: 50px;'>✓</span></div><div><a target='_blank' href='" + learnMore + "' class='learnMore' id='linkLearnInfo' >learn more</a><a target='_blank' href='" + walletLink + "' class='learnMore' id='linkMyWallet'>Check My Rewards</a></div></div></div>";
										createIframe(DomainHtml, myObj);
										createCashback();
									}
									for (var t = 0; t < cartpageUrl.length; t++) {
										if ((CurrHref.indexOf(cartpageUrl[t]) > -1) && (myObj.coupons.length > 0)) {
											popupHeight = "446px";
											backgroungClr = "#F4F4F4";
											popupWidth = "332px";
											style = "<style>*{box-sizing:border-box}.container{text-align:center;position:relative;padding:8px;background-color:#f6f6f6;font-family:'Lato', sans-serif;font-size:14px}.content{background:#fff;width:316px;float:left;height:430px;position:relative;box-shadow: 0.7px 0.7px 9.5px 0.5px rgba(0,0,0,.1);}.logo{display:inline-block}.logoPos{position:absolute;left:10px;top:9px}.logo img{width:35px}.content p{margin:5px; padding: 0 3px;}.groupImage{margin-bottom:10px;margin-top:117px;width:130px}h2{text-transform:capitalize;font-size:18px;color:#333132;font-family:Lato}h4{font-size:16px;color:#333132;margin:5px;font-weight:400}.sbtbtn{border:1px solid #ff6215;padding:8px 30px;margin-top:5px;color:#fff;font-size:14px;width:173px;cursor:pointer;border-radius:19px;background-color:#ff6215;font-family: Lato;font-weight: bold;}.sbtbtn:hover{background:#f5a972;border:1px solid #f5a972;}hr{color:#fff;display:block;border:0;border-top:1px solid #e5e5e5;margin:1em 20px}.close{cursor:pointer; margin-top: 4px;}.closePos{position:absolute;right:10px;top:10px}.cashes{opacity:0;width:16px;height:16px;background-repeat:no-repeat;background-size:100%;position:absolute;background-image-position:center center;background-repeat:no-repeat;-webkit-transition-timing-function:linear;-moz-transition-timing-function:linear;-ms-transition-timing-function:linear;-o-transition-timing-function:linear;transition-timing-function:linear;animation-fill-mode:forwards;-webkit-animation-name:moveUp;-moz-animation-name:moveUp;-ms-animation-name:moveUp;-o-animation-name:moveUp;animation-name:moveUp;animation-duration:6s;-ms-animation-iteration-count:infinite;-webkit-animation-iteration-count:infinite;-moz-animation-iteration-count:infinite;-o-animation-iteration-count:infinite;animation-iteration-count:infinite;transform:translateZ(0);will-change:transform}@-webkit-keyframes moveUp{0%{opacity:0;-webkit-transform:translate3d(0,0,0);-webkit-animation-timing-function:linear}25%{opacity:1;-webkit-transform:translate3d(0,145px,0);-webkit-animation-timing-function:linear}50%{opacity:1;-webkit-transform:translate3d(0,145px,0);-webkit-animation-timing-function:linear}85%{opacity:0;-webkit-transform:translate3d(0,145px,0);-webkit-animation-timing-function:linear}100%{opacity:0;-webkit-transform:translate3d(0,145px,0);-webkit-animation-timing-function:linear}}@-moz-keyframes moveUp{0%{opacity:0;-moz-transform:translate3d(0,0,0);-moz-animation-timing-function:linear}25%{opacity:1;-moz-transform:translate3d(0,145px,0);-moz-animation-timing-function:linear}50%{opacity:1;-moz-transform:translate3d(0,145px,0);-moz-animation-timing-function:linear}85%{opacity:0;-moz-transform:translate3d(0,145px,0);-moz-animation-timing-function:linear}100%{opacity:0;-moz-transform:translate3d(0,145px,0);-moz-animation-timing-function:linear}}@-ms-keyframes moveUp{0%{opacity:0;-ms-transform:translate3d(0,0,0);-ms-animation-timing-function:linear}25%{opacity:1;-ms-transform:translate3d(0,145px,0);-ms-animation-timing-function:linear}50%{opacity:1;-ms-transform:translate3d(0,145px,0);-ms-animation-timing-function:linear}85%{opacity:0;-ms-transform:translate3d(0,145px,0);-ms-animation-timing-function:linear}100%{opacity:0;-ms-transform:translate3d(0,145px,0);-ms-animation-timing-function:linear}}@-o-keyframes moveUp{0%{opacity:0;-o-transform:translate3d(0,0,0);-o-animation-timing-function:linear}25%{opacity:1;-o-transform:translate3d(0,145px,0);-o-animation-timing-function:linear}50%{opacity:1;-o-transform:translate3d(0,145px,0);-o-animation-timing-function:linear}85%{opacity:0;-o-transform:translate3d(0,145px,0);-o-animation-timing-function:linear}100%{opacity:0;-o-transform:translate3d(0,145px,0);-o-animation-timing-function:linear}}@keyframes moveUp{0%{opacity:0;transform:translate3d(0,0,0);animation-timing-function:linear}25%{opacity:1;transform:translate3d(0,145px,0);animation-timing-function:linear}50%{opacity:1;transform:translate3d(0,145px,0);animation-timing-function:linear}85%{opacity:0;transform:translate3d(0,145px,0);animation-timing-function:linear}100%{opacity:0;transform:translate3d(0,145px,0);animation-timing-function:linear}}.cash1{background-image:url(" + imagePathLoc + "money.png);background-size:100% 100%;left:52%;width:35px;height:35px;-o-animation-delay:2s;animation-delay:2s;-webkit-animation-delay:2s;-moz-animation-delay:2s;-ms-animation-delay:2s;z-index:999}.cash2{background-image:url(" + imagePathLoc + "money.png);background-size:100% 100%;left:48%;width:35px;height:35px;-o-animation-delay:3s;animation-delay:3s;-webkit-animation-delay:3s;-moz-animation-delay:3s;-ms-animation-delay:3s;z-index:999}.cash3{background-image:url(" + imagePathLoc + "money.png);background-size:100% 100%;left:45%;width:35px;height:35px;-o-animation-delay:4s;animation-delay:4s;-webkit-animation-delay:4s;-moz-animation-delay:4s;-ms-animation-delay:4s;z-index:999}.blink{width:130px;height:117px;background-image:url(" + imagePathLoc + "blink.png);position:absolute;animation:blink .5s linear infinite;z-index:9999;margin:0;top:149px;left:102px;background-size:100%}@keyframes blink{0%{opacity:0}100%{opacity:1}}.coupon-code {text-transform: capitalize;margin-top: 10px;padding-left: 36px;position: absolute;width: 100%;}.coupon-code span {font-weight: bold;}:focus{outline:none}body {margin: 0px;}</style>";
											DomainHtml = fontApi + "<div class='container'> <div class='cashes cash1'></div><div class='cashes cash2'></div><div class='cashes cash3'></div><div class='blink'> </div><div class='content'> <div class='logo logoPos'> <img src='" + imagePathLoc + "logo_49x21.png'/> </div><div class='coupon-code'>Coupon codes: <span>" + codeCount + "</span></div><div class='close closePos' id='closeiframe' ><img style='width: 10px;' src='" + imagePathLoc + "cross.png'> </div><img class='groupImage' src='" + imagePathLoc + "new_group.png'/> <h2>Coupons Found!</h2> <hr/> <p>We'll test these offers and automatically apply the savings to your items, if applicable.</p> <hr/> <div> <button  class='sbtbtn' id='applysavings' type='submit'>Apply Coupons</button><span></span> </div></div></div>";
											createIframe(DomainHtml, myObj);
										}
									}
								}
...
var jsonObj;
function createIframe(DomainHtml, jsonObj) {
	closeframe();
	...
	if (!location.ancestorOrigins.contains(extensionOrigin)) {
		...
		if (!iframeExists) {
			...
			iframe.setAttribute("style", "position:fixed;top:10px;right:10px;border:0.8px solid #e8dfdf;padding:0;display:inline-block;width:" + popupWidth + ";height:" + popupHeight + ";z-index:9999999999;opacity:1;background-color:" + backgroungClr + ";");
		...
		setTimeout(function () {
			...
			if (iframe.contentWindow.document.getElementById('closeWelcome')) {
				iframe.contentWindow.document.getElementById('closeWelcome').addEventListener('click', closeframe);
			}
		}, 1500);
			...
			if (jsonObj.coupons.length > 0) {
				...
				while (i < codeCount) {
					...
					if (couponsTitle == null) {
						couponsTitle = jsonObj.coupons[i].discount;
					}
					var couponsDiscript = jsonObj.coupons[i].description;
					if (couponsDiscript == null) {
						couponsDiscript = "";
					}
					var couponHtml = fontApi + "<div  style='border:1px solid gray; margin-top: 10px; position: relative;'><input type='button' class='btnCoupon' id='btnCoupon" + i + "' value='" + couponsCode + "' style='display:block;margin:5px 10px;cursor:pointer;'/><span class='copyIcon' color:'green' style='position: absolute;top: 0px; left: 100px;display:block;margin:5px 10px; visibility:hidden;color:green;'>&#10003 Copied</span><h3 style='text-align: left;font-size: 15px;padding: 0px 10px 0px; margin:5px 0;'>" + couponsTitle + "</h3><p style='text-align:left;font-size:13px;padding:0px 10px;margin: 3px 0;'>" + couponsDiscript + "</p></div>";
					if ((!document.getElementById('appendCoupon' + i)) && (output)) {
...
function closeframe() {
	var closeiFrame = document.getElementById("couponchiefiframe");
	if (closeiFrame != null) {
		closeiFrame.parentNode.removeChild(closeiFrame);
	}
...
function CashBack() {
	...
	chrome.storage.local.get(CurrHost, function (result) {
		myObj = result[CurrHost];
		if (myObj) {
			cashbackEndDate = myObj.cashback[0].endDate;
...
if (CurrHref.indexOf("bloomingdales.com") > -1) {
	...
	if (CurrHref.indexOf("www.orientaltrading.com") > -1) {
		...
		orientalhttp.open("GET", "https://secure.checkout.orientaltrading.com/checkout/rest/promocode/" + couponCode, false);
		orientalhttp.send();
	}
					...
					nySavinghttp.onreadystatechange = function () {
						if (this.readyState == 4 && this.status == 200) {
							try {
								var parser = new DOMParser();
								var doc = parser.parseFromString(this.responseText, "text/html");
								var savingClass = doc.getElementsByClassName("t-cell line-value discounted")[0];
								if (savingClass) {
	...
	if (CurrHref.indexOf("www.kennethcole.com") > -1) {
		try {
			...
			params = "dwfrm_cart_couponCode=" + couponCode + "&dwfrm_cart_addCoupon=dwfrm_cart_addCoupon";
			paramsR = "dwfrm_cart_coupons_i0_deleteCoupon=Remove&dwfrm_cart_updateCart=dwfrm_cart_updateCart&dwfrm_cart_couponCode=";
	...
	if (CurrHref.indexOf("spirithalloween.com") > -1) {
		try {
			...
			var params = "promoCode=" + couponCode + "&delete=false";
	...
	if (CurrHref.indexOf("www.fragrancenet.com") > -1) {
		var params = "activeCoupon=&gc_coupon_id=" + couponCode;
...
function savingsGenerate() {
		...
		setTimeout(function () {
			try {
				...
				if(check)
				{
				  ...
				  totalSavings = check.getElementsByTagName('span')[1].innerText.replace(/[-$,]/g, '');	
				}
				SavingsPopup(finalCode, totalSavings);
			} catch (e) {
				SavingsPopup(finalCode, totalSavings);
			...
			if (this.readyState == 4) {
				try {
					...
					if(check)
					{
					  ...
					  finalCode = finalCode.replace(/\(|\)/g, '');
					  totalSavings = doc.getElementsByClassName("discount-amount column")[0].innerText.replace(/[-$,]/g, '');
					}
					SavingsPopup(finalCode, totalSavings);
				} catch (e) {
					SavingsPopup(finalCode, totalSavings);
	...
	if (CurrHref.indexOf("dell.com") > -1) {
		try {
			var params = "{'CouponCode':'" + finalCode + "'}";
			var dellhttp = new XMLHttpRequest();
			dellhttp.onreadystatechange = function () {
	...
	if (!location.ancestorOrigins.contains(extensionOrigin)) {
		...
		setTimeout(function () {
			...
			if ((cashbackValue) && (cashbackDiv)) {
				var cashbackHtmlCode = "<p style='margin-top: 20px;'>Cash Back saves you an additional</p><p><span class='numberCode' style='font-size: 20px;'>" + cashbackValue + "</span></p><div style='position:relative'><button class='sbtbtn' id='applycashback' >Log In & Activate</button><button class='actbtn' id='activeCashback' >Activate</button><span id='checkCashback' style='color: rgb(40, 198, 197);display: none;font-size: 20px;position:absolute;top: 15px;right: 35px;'>✓</span></div>";
...
function savingsAtOnload() {
	var autoparts = localStorage.getItem("autoparts");
	if ((CurrHref.indexOf("shop.advanceautoparts.com") > -1) && (autoparts == "true")) {
		try {
			var discDiv = document.getElementsByClassName("aap-cart-order-summary__discount");
			var divLength = discDiv.length;
			for (var k = 0; k < divLength; k++) {
				var divTitle = discDiv[k].getElementsByClassName("aap-cart-order-summary__discount-title")[0];
				if (divTitle) {
					if ((divTitle.innerText == "Promotional Discounts") || (divTitle.innerText == "PROMOTIONAL DISCOUNTS")) {
						var totalSavings = discDiv[k].getElementsByClassName("aap-cart-order-summary__line-item-amount discount")[0].innerText.replace("−", "");
						var finalCode = discDiv[k].getElementsByClassName("aap-cart-order-summary__line-item-description")[0].innerText;
						var n = finalCode.split(" ");
						finalCode = n[0];
					}
				}
			}
			SavingsPopup(finalCode, totalSavings);
			localStorage.setItem("autoparts", "false");
		} catch (e) {
			SavingsPopup(finalCode, totalSavings);
			Raven.captureException("AppVersion:" + appVersion + ", StoreName: " + CurrHost + ", Invalid Element, " + e);
		}
	...
	var checkAvenue = localStorage.getItem("avenue");
	if(checkAvenue){
         var successClass = document.getElementsByClassName("totals discounts");
		 if(successClass){
			var totalSavings = Number(successClass[0].getElementsByClassName("price")[0].innerText.replace(/[-$,]/g, ''));
			finalCode = checkAvenue;
		 }
		 SavingsPopup(finalCode, "$" + totalSavings);
		localStorage.setItem("avenue", "");
	}

		setTimeout(() => {
			var checkFootlocker = localStorage.getItem("footlocker");
			if(checkFootlocker){
				var orderSummaryClass = document.getElementsByClassName("OrderSummary-list");
				for(var k=0 ; k < orderSummaryClass.length; k++){
					if(orderSummaryClass[k].getElementsByTagName("dt")[0].innerText == "DISCOUNTS:"){
					var totalSavings = orderSummaryClass[k].getElementsByTagName("dd")[0].innerText.replace(/[$,-]/g, '');
					}
				}
				if(document.getElementsByClassName("OrderSummary-voucher")[0]){
					var finalCode = document.getElementsByClassName("OrderSummary-voucher")[0].innerText.replace(/[Coupon Remove (),]/g, '');
				}
				SavingsPopup(finalCode, "$" + totalSavings);
				localStorage.setItem("footlocker", "");
			}
		}, 4000);
...
function isInSupportedSites(CurrHost) {
	...
	CurrHost = CurrHost.replace("www3.", "");
	CurrHost = CurrHost.replace("www8.", "");
	if (CurrHref.indexOf("hp.com") > -1) {
		CurrHost = CurrHost.replace("store.", "");
	}
	if (CurrHref.indexOf("shop.dunkindonuts.com") > -1) {
		CurrHost = CurrHost.replace("shop.", "");
	}
	if ((CurrHref.indexOf("checkout.bodenusa.com") > -1) || (CurrHref.indexOf("checkout.blair.com") > -1)) {
		CurrHost = CurrHost.replace("checkout.", "");
...
function isInSupportCart(CurrHref) {
	for (site in partners.SupportedSites) {
		if (CurrHref.indexOf(partners.SupportedSites[site].cart) > -1) {
			return 1;
		}
	}
	return 0;
